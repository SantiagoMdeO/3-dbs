...
from model import HighlightInteraction, HighlightInteractionsUpdate
...
#HighlightInteraction HighlightInteractionsUpdate
...
def create_post(request: Request, post: HighlightInteraction = Body(...)):
...
@router.get("/", response_description="List all posts", response_model=List[HighlightInteraction])
...
#this works
@router.get("/id/{id}", response_description="Get a single post by ID", response_model=HighlightInteraction)
...
@router.get("/query/", response_description="get many posts by your query(not by _id)", response_model=HighlightInteraction)
def find_post(request: Request, post: HighlightInteractionsUpdate = Body(...)):
...
# Update a post
@router.put("/id/{id}", response_description="Update a post", response_model=HighlightInteraction)
def update_post(id: str, request: Request, post_update: HighlightInteractionsUpdate = Body(...)):
