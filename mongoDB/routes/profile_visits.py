...
from model import ProfileVisit, ProfileVisitsUpdate
...
#ProfileVisit ProfileVisitsUpdate
...
def create_post(request: Request, post: ProfileVisit = Body(...)):
...
@router.get("/", response_description="List all posts", response_model=List[ProfileVisit])
...
#this works
@router.get("/id/{id}", response_description="Get a single post by ID", response_model=ProfileVisit)
...
@router.get("/query/", response_description="get many posts by your query(not by _id)", response_model=ProfileVisit)
def find_post(request: Request, post: ProfileVisitsUpdate = Body(...)):
...
# Update a post
@router.put("/id/{id}", response_description="Update a post", response_model=ProfileVisit)
def update_post(id: str, request: Request, post_update: ProfileVisitsUpdate = Body(...)):
