...
from model import Activity, ActivitiesUpdate
...
def create_post(request: Request, post: Activity = Body(...)):
...
@router.get("/", response_description="List all posts", response_model=List[Activity])
...
#this works
@router.get("/id/{id}", response_description="Get a single post by ID", response_model=Activity)
...
@router.get("/query/", response_description="get many posts by your query(not by _id)", response_model=Activity)
def find_post(request: Request, post: ActivitiesUpdate = Body(...)):
...
# Update a post
@router.put("/id/{id}", response_description="Update a post", response_model=Activity)
def update_post(id: str, request: Request, post_update: ActivitiesUpdate = Body(...)):
